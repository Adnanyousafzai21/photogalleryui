...
const SingleBox = () => {
  ...
  return (
    <div className="w-[95%] max-w-[1210px] flex flex-wrap gap-9 justify-center h-screen  items-start py-10 m-auto" >
      {images.length === 0 ? (
        <h2 className=' w-full text-center text-customtextbold text-xl mt-10'>Your uploaded images will be showing here</h2>
      ) : (
